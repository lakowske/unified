...
class TestDataManager:
    ...
    def validate_test_data_structure(self) -> Dict[str, Any]:
        ...
        required_dirs = [self.test_data_dir, self.environments_dir, self.validation_dir, self.fixtures_dir]
        ...
        expected_environments = ["minimal", "full-stack", "port-conflict", "isolated-feature", "performance"]
        ...
        validation_files = ["expected_ports.json", "service_health.json", "startup_order.json"]
        ...
        # Check fixture files
        fixture_files = ["test_users.json", "dns_records.json", "mail_config.json"]
    ...
    def generate_test_report(self) -> Dict[str, Any]:
        ...
        report = {
            ...
            "environments": {},
            "summary": {"total_environments": 0, "valid_environments": 0, "total_ports": 0, "conflicting_ports": 0},
        }

        # Validate each environment
        environment_names = ["minimal", "full-stack", "feature-auth", "performance", "conflict1", "conflict2"]
    ...
    def setup_test_environment(self, env_name: str) -> Dict[str, Any]:
        ...
        """
        result = {"success": True, "environment": env_name, "steps": [], "errors": []}
        ...
        try:
            ...
            try:
                subprocess.run(["docker", "image", "inspect", base_image], capture_output=True, check=True, timeout=10)
        ...
        try:
            ...
            try:
                ...
                if proc.returncode == 0:
                    ...
                    if container_names:
                        # Stop containers
                        subprocess.run(["docker", "stop"] + container_names, capture_output=True, timeout=60)

                        # Remove containers
                        subprocess.run(["docker", "rm"] + container_names, capture_output=True, timeout=30)
            ...
            try:
                ...
                if proc.returncode == 0:
                    ...
                    if volume_names:
                        subprocess.run(["docker", "volume", "rm"] + volume_names, capture_output=True, timeout=30)
