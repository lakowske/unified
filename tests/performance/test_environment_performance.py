...
class TestEnvironmentPerformance:
    ...
    def test_environment_scaling_performance(self):
        ...
        for env in environments:
            ...
            env_results = self.runner.run_environment_performance_test(env, iterations=1, include_warmup=False)
    ...
    def test_environment_performance_baseline(self):
        ...
        # Run initial test
        results1 = self.runner.run_environment_performance_test(environment, iterations=2, include_warmup=True)
