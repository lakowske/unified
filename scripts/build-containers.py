...
class ContainerBuilder:
    ...
    def _define_containers(self) -> Dict[str, ContainerConfig]:
        ...
        return {
            ...
            "poststack-cli": ContainerConfig(
                name="poststack-cli",
                dockerfile_path="/home/seth/Software/dev/unified/containers/poststack/Dockerfile",
                build_context="/home/seth/Software/dev/poststack",
                image_tag="localhost/poststack/cli:latest",
                dependencies=["base-debian"],
                description="Simplified poststack CLI for database operations"
            ),
        ...
        try:
            ...
            if check_result.returncode == 0 and check_result.stdout.strip():
                ...
                with open(log_file, "w") as log_handle:
                    ...
                    log_handle.write(f"Status: SKIPPED - Image already exists\n")
    ...
    async def build_all(self) -> Dict[str, BuildResult]:
        ...
        for level_num, level_containers in enumerate(build_levels, 1):
            ...
            tasks = [
                self._build_container(container_name) 
    ...
    def _generate_build_summary(self):
        ...
        summary = {
            ...
            "build_results": {
                name: asdict(result) for name, result in self.build_results.items()
            },
            "performance_metrics": {
                ...
                "average_build_time": sum(r.build_time for r in successful_builds) / len(successful_builds) if successful_builds else 0,
