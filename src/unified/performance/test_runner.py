...
class PerformanceTestRunner:
    ...
    def __init__(self, project_dir: Union[str, Path], output_dir: Optional[Path] = None, 
        ...
        if environments_dir == "environments/test-data":
            ...
            class TestEnvironmentConfig(EnvironmentConfig):
                def load_environment(self, environment: str) -> Dict[str, Any]:
                    ...
                    compose_file = self.project_dir / "environments" / "test-data" / environment / f"docker-compose.{environment}.yml"
    ...
    def run_environment_performance_test(self, environment_name: str, 
                                       iterations: Optional[int] = None,
                                       include_warmup: bool = True) -> Dict[str, Any]:
    ...
    def _collect_startup_performance(self, environment_name: str, container_names: List[str],
                                   startup_start: float, startup_end: float) -> Dict[str, Any]:
    ...
    def _collect_final_performance(self, environment_name: str, container_names: List[str],
                                  shutdown_start: float, shutdown_end: float) -> Dict[str, Any]:
        """Collect final performance data including shutdown events.
    ...
    def run_all_environments_test(self, environment_filter: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        for env_name in test_environments:
            ...
            try:
                ...
                combined_results["results"][env_name] = {
                    "error": str(e),
    ...
    def _calculate_overall_summary(self, environment_results: Dict[str, Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if avg_startup_times:
            ...
            summary["slowest_environment"] = {
                "name": slowest_env,
                "startup_time": avg_startup_times[slowest_env]
            }
            summary["fastest_environment"] = {
                "name": fastest_env,
                "startup_time": avg_startup_times[fastest_env]
            }
