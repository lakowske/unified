...
GRANT SELECT, INSERT, UPDATE, DELETE ON unified.dns_records TO test_user_2;
GRANT SELECT, INSERT, UPDATE, DELETE ON unified.dns_zones TO test_user_2;
GRANT USAGE ON SEQUENCE unified.dns_records_id_seq TO test_user_2;
GRANT USAGE ON SEQUENCE unified.dns_zones_id_seq TO test_user_2;
